...
// CHANGE THIS URL after deploying your backend (e.g., to Render or Railway)
// Example: const API_URL = 'https://your-flask-app.onrender.com';
const API_URL = ''; 
...
async function calculateResult() {
    ...
    try {
        ...
        alert('An error occurred while calculating. Make sure the backend is running and API_URL is correct.');
    } finally {
